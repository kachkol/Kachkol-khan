...
╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝ ╚══════╝    ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═══╝
        ...
        ︻デ═一 HACKER :  Kachkol Khan Official
\x1b[1;94m────────────────────────────────────────────────────
\x1b[1;97m [\x1b[1;94m•\x1b[1;92m•\x1b[1;97m] Author   :  Kachkol Khan Official
\x1b[1;97m [\x1b[1;92m•\x1b[1;94m•\x1b[1;97m] Github   : https://github.com/Kachkol khan Official
...
╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝ ╚══════╝    ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═══╝
              ...
              ︻デ═一 HACKER : Kachkol Khan
\x1b[1;94m────────────────────────────────────────────────────
\x1b[1;97m [\x1b[1;92m+\x1b[1;97m] Author   : Kachkol Khan
\x1b[1;97m [\x1b[1;92m+\x1b[1;97m] Github   : https://github.com/Kachkol Khan Official
...
def moch_yayan():
    time.sleep(0.1)
    print("\033[97m [\033[96m01\033[97m] Start Crake ID with Kachkol Khan")
    ...
    if yayan == "1" or yayan == "01":
        ...
        if __name__ == '__main__':
            try:
                ...
                jembut()
                print(
                    '\n\x1b[1;96m        ∆∆∆_______Kachkol Khan ᴴᴬᶜᴷᴱᴿ 𝙸𝚖 𝚗𝚘𝚝 𝚋𝚊𝚍 𝚒𝚖 𝚢𝚘𝚞 𝚊𝚛𝚎 𝚍𝚊𝚍 . _______∆∆∆')
                print('\x1b[1;95m     疊╔═╦═────••♽••─────═╦═╗疊')
                ...
                jembut()
                print(
                    '\n\x1b[1;92m        ∆∆∆_______Kachkol Khan ᴴᴬᶜᴷᴱᴿ 𝙸𝚖 𝚗𝚘𝚝 𝚋𝚊𝚍 𝚒𝚖 𝚢𝚘𝚞 𝚊𝚛𝚎 𝚍𝚊𝚍 . _______∆∆∆')
                print('\x1b[1;97m     疊╔═╦═────••♽••─────═╦═╗疊')
